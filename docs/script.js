...
const t = {
  en: {
    ...
    'exp.hiwi.desc': 'Student research assistant at the Institute for Control Engineering of Machine Tools and Manufacturing Units, supporting research and frontend development.',
    'exp.uni.title': 'B.Sc. Software Engineering',
    'exp.uni.desc': 'Studying software architecture, algorithms, computer architecture, and systems programming. Projects span from processor design in VHDL to full-stack web applications.',
  ...
  de: {
    ...
    'exp.hiwi.title': 'Studentische Hilfskraft',
    'exp.hiwi.desc': 'Studentische Hilfskraft am Institut für Steuerungstechnik der Werkzeugmaschinen und Fertigungseinrichtungen, mit Unterstützung in Forschung und Frontend-Entwicklung.',
    'exp.uni.title': 'B.Sc. Software Engineering',
    'exp.uni.desc': 'Studium mit Schwerpunkten in Softwarearchitektur, Algorithmen, Rechnerarchitektur und Systemprogrammierung. Projekte reichen vom Prozessordesign in VHDL bis zu Full-Stack-Webanwendungen.',
    'exp.school.title': 'Abitur',
    'exp.school.org': 'Oscar-Paret-Schule Freiberg am Neckar',
