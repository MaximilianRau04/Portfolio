const t = {
  de: {
    ...
    "p.person":
      "Diese Website ist eine private Portfolio-Seite einer Privatperson. Es besteht keine gewerbliche Tätigkeit im Sinne des Gewerberechts.",
  ...
  en: {
    ...
    "h.person": "Note",
    "p.person":
      "This website is a private portfolio site of a private individual. There is no commercial activity in the sense of trade law.",
    "h.liability-content": "Liability for Content",
    "p.liability-content":
      "As a service provider, I am responsible for my own content on these pages in accordance with general laws (§ 7 para. 1 DDG). However, I am not obligated to monitor transmitted or stored third-party information or to investigate circumstances that indicate illegal activity (§§ 8–10 DDG).",
    "h.liability-links": "Liability for Links",
    "p.liability-links":
      "My website contains links to external third-party websites over whose content I have no influence. I therefore cannot accept any liability for this external content. The respective provider or operator of the linked pages is always responsible for their content.",
